...
// No-op animations for characters whose sprite sheets don't contain a given
// animation. Prevents base bonzi frame indices from leaking onto agent sheets.
const characterStubAnimations = {
    cool_fwd: { frames: [0], next: "idle", speed: 1 },
    cool_still: 0,
    cool_back: { frames: [0], next: "idle", speed: 1 },
    cool_right_fwd: { frames: [0], next: "idle", speed: 1 },
    cool_right_still: 0,
    cool_right_back: { frames: [0], next: "idle", speed: 1 },
    cool_left_fwd: { frames: [0], next: "idle", speed: 1 },
    cool_left_still: 0,
    cool_left_back: { frames: [0], next: "idle", speed: 1 },
    cool_adjust: { frames: [0], next: "idle", speed: 1 },
    backflip: { frames: [0], next: "idle", speed: 1 },
    beat_fwd: { frames: [0], next: "idle", speed: 1 },
    beat_still: 0,
    beat_back: { frames: [0], next: "idle", speed: 1 },
    look_down_fwd: { frames: [0], next: "idle", speed: 1 },
    look_down_still: 0,
    look_down_back: { frames: [0], next: "idle", speed: 1 },
    lean_left_fwd: { frames: [0], next: "idle", speed: 1 },
    lean_left_still: 0,
    lean_left_back: { frames: [0], next: "idle", speed: 1 },
    look_left_fwd: { frames: [0], next: "idle", speed: 1 },
    look_left_still: 0,
    look_left_back: { frames: [0], next: "idle", speed: 1 },
    look_right_fwd: { frames: [0], next: "idle", speed: 1 },
    look_right_still: 0,
    look_right_back: { frames: [0], next: "idle", speed: 1 },
    lean_right_fwd: { frames: [0], next: "idle", speed: 1 },
    lean_right_still: 0,
    lean_right_back: { frames: [0], next: "idle", speed: 1 },
};

// Frame sizes verified against the actual sprite sheets (transparent gutters
// + every referenced frame landing on a drawn cell).
const characterProfiles = {
    peedy: {
        width: 160, height: 128, sheetWidth: 4960, sheetHeight: 4096,
        animations: {
            idle: 0,
            surf_across_fwd: [1, 8, "surf_across_still", 1],
            surf_across_still: 9,
            ...
            clap_still: [13, 15, "clap_still", 1],
            clap_back: { frames: animationRange(12, 10), next: "idle", speed: 1 },
            surf_intro: [6, 28, "idle", 1],
            surf_away: [377, 400, "gone", 1],
            gone: 400,
            shrug_fwd: [253, 260, "shrug_still", 1],
            shrug_still: 260,
            shrug_back: { frames: animationRange(260, 253), next: "idle", speed: 1 },
            earth_fwd: [575, 581, "earth_still", 1],
            earth_still: [584, 616, "earth_still", 1],
            earth_back: { frames: animationRange(580, 575), next: "idle", speed: 1 },
            look_down_fwd: [218, 222, "look_down_still", 1],
            look_down_still: 222,
            look_down_back: { frames: animationRange(222, 218), next: "idle", speed: 1 },
            lean_left_fwd: [94, 97, "lean_left_still", 1],
            lean_left_still: 98,
            lean_left_back: { frames: animationRange(97, 94), next: "idle", speed: 1 },
            surprised_fwd: { frames: [0, 294, 295, 296, 296, 297, 298, 299, 300, 300, 300, 300, 303, 304], next: "surprised_still", speed: 1 },
            surprised_still: 304,
            surprised_back: { frames: [312, 313, 314], next: "idle", speed: 1 },
            clicked: { frames: [0, 294, 295, 296, 296, 297, 298, 299, 300, 300, 300, 300, 303, 304, 304, 304, 304, 304, 312, 313, 314], next: "idle", speed: 1 },
            cool: {
                frames: [
                    617, 618, 619, 620, 620, 620, 620, 620, 620, 621, 622, 623, 624, 625, 626, 627, 628, 629, 630, 631,
                    632, 632, 632, 632, 632, 632, 632, 632, 632, 632, 632, 632, 632, 632, 632, 632, 632, 632, 632, 632,
                    632, 632, 632, 632, 632, 632, 632, 632, 632, 632, 632, 632, 632, 632, 632, 632, 632, 633, 634,
                    635, 635, 635, 635, 635, 635, 635, 635, 635, 635, 634,
                    632, 632, 632, 632, 632, 632, 632, 632, 632, 632, 632, 632,
                    636, 637, 638, 638, 638, 638, 638, 638, 638, 638, 638, 638, 638, 637, 636,
                    632, 632, 632, 632, 632, 632, 632, 632, 632, 632, 632, 632, 632, 632, 632, 632, 632,
                    631, 630, 629, 628, 627, 626, 625, 624, 623, 622, 621, 620, 619, 618, 617, 0,
                ],
                next: "idle", speed: 1,
            },
            cool_peedy: {
            ...
            cool_right_back: { frames: animationRange(128, 126), next: "idle", speed: 1 },
            cool_left_fwd: [131, 133, "cool_left_still", 1],
            cool_left_still: 134,
            cool_left_back: { frames: animationRange(133, 131), next: "cool_still", speed: 1 },
            ...
            look_left_still: 146,
            look_left_back: { frames: animationRange(145, 143), next: "idle", speed: 1 },
            look_left: {
            ...
            look_right_back: { frames: animationRange(151, 149), next: "idle", speed: 1 },
            lean_right_fwd: { frames: animationRange(158, 156), next: "lean_right_still", speed: 1 },
            lean_right_still: 155,
            lean_right_back: [156, 158, "idle", 1],
            praise_fwd: [91, 95, "praise_still", 1],
            praise_still: 95,
            praise_back: { frames: animationRange(95, 91), next: "idle", speed: 1 },
            grin_fwd: [743, 753, "grin_still", 1],
            grin_still: 747,
            grin_back: { frames: animationRange(747, 743), next: "idle", speed: 1 },
            taptaptap: { frames: [177, 178, 179, 180, 181], next: "idle", speed: 1 },
            breathe: { frames: [342, 343, 344, 345, 346, 347, 348, 348, 348, 348, 348, 348, 347, 346, 345, 344, 343, 342], next: "idle", speed: 1 },
            backflip: { frames: [0, 412, 413, 414, 415, 416, 416, 417, 418, 419, 420, 419, 418, 417, 416, 415, 414, 413, 412, 0], next: "idle", speed: 1 },
            sleep_fwd: { frames: [0, 919, 964, 964, 964, 964, 967, 969, 969, 970], next: "sleep_still", speed: 1 },
            sleep_still: {
                frames: [
                    970, 970, 970, 970, 970, 970, 970, 970, 970, 970, 970, 970, 970, 970, 970, 970, 970, 970, 970, 970,
                    970, 970, 970, 970, 970, 971, 972, 973, 974, 975,
                    976, 976, 976, 976, 976, 976, 976, 976, 976, 976,
                    975, 974, 973, 972, 971, 970,
                ],
                next: "sleep_still", speed: 1,
            },
            sleep_back: { frames: [970, 969, 969, 967, 674, 919, 0], next: "idle", speed: 1 },
            beat_fwd: { frames: [0], next: "idle", speed: 1 },
            beat_still: 0,
            beat_back: { frames: [0], next: "idle", speed: 1 },
        },
    ...
    genie: {
        width: 128, height: 130, sheetWidth: 4096, sheetHeight: 2470,
        animations: {
            ...characterStubAnimations,
            idle: 0,
            surf_across_fwd: [1, 8, "surf_across_still", 1],
            surf_across_still: 9,
            surf_across_back: { frames: animationRange(8, 1), next: "idle", speed: 1 },
            clap_fwd: [577, 581, "clap_still", 1],
            clap_still: [579, 581, "clap_still", 1],
            clap_back: { frames: animationRange(578, 577), next: "idle", speed: 1 },
            surf_intro: [86, 95, "idle", 1],
            surf_away: [96, 106, "gone", 1],
            gone: 590,
            shrug_fwd: [271, 275, "shrug_still", 1],
            shrug_still: 275,
            shrug_back: { frames: animationRange(275, 271), next: "idle", speed: 1 },
            earth_fwd: [385, 391, "earth_still", 0.6],
            earth_still: [391, 396, "earth_still", 0.6],
            earth_back: [397, 402, "idle", 0.6],
            cool: { frames: [0], next: "idle", speed: 1 },
            cool_peedy: { frames: [0], next: "idle", speed: 1 },
            present_fwd: [107, 111, "present_still", 1],
            present_still: 111,
            present_back: { frames: animationRange(111, 107), next: "idle", speed: 1 },
            look_left: { frames: [0], next: "idle", speed: 1 },
            look_right: { frames: [0], next: "idle", speed: 1 },
            look_down: { frames: [0], next: "idle", speed: 1 },
            praise_fwd: [361, 365, "praise_still", 1],
            praise_still: 365,
            praise_back: { frames: animationRange(365, 361), next: "idle", speed: 1 },
            grin_fwd: [161, 165, "grin_still", 1],
            grin_still: 165,
            grin_back: { frames: animationRange(165, 161), next: "idle", speed: 1 },
            taptaptap: { frames: [0], next: "idle", speed: 1 },
            breathe: { frames: [0], next: "idle", speed: 1 },
        },
    },
    merlin: {
        width: 128, height: 128, sheetWidth: 3968, sheetHeight: 2560,
        animations: {
            ...characterStubAnimations,
            idle: 0,
            surf_across_fwd: [1, 8, "surf_across_still", 1],
            surf_across_still: 9,
            surf_across_back: { frames: animationRange(8, 1), next: "idle", speed: 1 },
            clap_fwd: [445, 457, "clap_still", 1],
            clap_still: [349, 350, "clap_still", 1],
            clap_back: { frames: animationRange(349, 345), next: "idle", speed: 1 },
            surf_intro: [128, 136, "idle", 1],
            surf_away: [137, 149, "gone", 1],
            gone: 613,
            shrug_fwd: [174, 178, "shrug_still", 1],
            shrug_still: 178,
            shrug_back: { frames: animationRange(178, 174), next: "idle", speed: 1 },
            earth_fwd: [186, 190, "earth_still", 0.6],
            earth_still: [190, 199, "earth_still", 0.6],
            earth_back: { frames: animationRange(190, 186), next: "idle", speed: 1 },
            cool: { frames: [0], next: "idle", speed: 1 },
            cool_peedy: { frames: [0], next: "idle", speed: 1 },
            present_fwd: [117, 120, "present_still", 1],
            present_still: 120,
            present_back: { frames: animationRange(120, 117), next: "idle", speed: 1 },
            look_left: { frames: [0], next: "idle", speed: 1 },
            look_right: { frames: [0], next: "idle", speed: 1 },
            look_down: { frames: [0], next: "idle", speed: 1 },
            praise_fwd: [82, 86, "praise_still", 1],
            praise_still: 86,
            praise_back: { frames: animationRange(86, 82), next: "idle", speed: 1 },
            grin_fwd: [345, 350, "grin_still", 1],
            grin_still: 350,
            grin_back: { frames: animationRange(350, 345), next: "idle", speed: 1 },
            taptaptap: { frames: [0], next: "idle", speed: 1 },
            breathe: { frames: [0], next: "idle", speed: 1 },
        },
    },
    robby: {
        width: 128, height: 128, sheetWidth: 4096, sheetHeight: 2432,
        animations: {
            ...characterStubAnimations,
            idle: 0,
            surf_across_fwd: [1, 8, "surf_across_still", 1],
            surf_across_still: 9,
            surf_across_back: { frames: animationRange(8, 1), next: "idle", speed: 1 },
            clap_fwd: [121, 128, "shrug_still", 1],
            clap_still: 128,
            clap_back: { frames: animationRange(128, 121), next: "idle", speed: 1 },
            surf_intro: [53, 70, "idle", 1],
            surf_away: [369, 389, "gone", 1],
            gone: 593,
            shrug_fwd: [175, 177, "shrug_still", 1],
            shrug_still: 177,
            shrug_back: { frames: animationRange(177, 175), next: "idle", speed: 1 },
            earth_fwd: [290, 298, "earth_still", 1],
            earth_still: [300, 306, "earth_still", 1],
            earth_back: { frames: animationRange(298, 290), next: "idle", speed: 1 },
            cool: { frames: [0], next: "idle", speed: 1 },
            cool_peedy: { frames: [0], next: "idle", speed: 1 },
            present_fwd: [207, 211, "present_still", 1],
            present_still: 211,
            present_back: { frames: animationRange(211, 207), next: "idle", speed: 1 },
            look_left: { frames: [0], next: "idle", speed: 1 },
            look_right: { frames: [0], next: "idle", speed: 1 },
            look_down: { frames: [0], next: "idle", speed: 1 },
            praise_fwd: [219, 221, "praise_still", 1],
            praise_still: 221,
            praise_back: { frames: animationRange(221, 219), next: "idle", speed: 1 },
            grin_fwd: [345, 350, "grin_still", 1],
            grin_still: 350,
            grin_back: { frames: animationRange(350, 345), next: "idle", speed: 1 },
            taptaptap: { frames: [0], next: "idle", speed: 1 },
    ...
    clippit: {
        width: 124, height: 93, sheetWidth: 4092, sheetHeight: 2604,
        animations: {
            idle: 0,
            surf_across_fwd: [1, 8, "surf_across_still", 1],
            surf_across_still: 9,
            ...
            surf_intro: { frames: [347, 346, 345, 489, 490, 491, 492, 493, 0], next: "idle", speed: 1 },
            surf_away: {
            ...
            gone: 902,
            shrug_fwd: [89, 91, "shrug_still", 1],
            shrug_still: 91,
            shrug_back: { frames: animationRange(91, 89), next: "idle", speed: 1 },
            earth_fwd: [777, 797, "earth_still", 1],
            earth_still: [797, 808, "earth_still", 1],
            earth_back: { frames: [808, 809, 810, 811, 784, 783, 782, 781, 780, 779, 778, 777, 0], next: "idle", speed: 1 },
            sleep_fwd: {
                frames: [0, 565, 566, 567, 568, 569, 570, 571, 572, 573, 574, 575, 576, 577, 578, 579, 580, 581, 582, 583, 584, 585, 586, 587, 588, 589, 590, 591],
                next: "sleep_still", speed: 1,
            },
            sleep_still: { frames: [591, 592, 593, 594, 595, 596, 597, 598, 599, 600, 601], next: "sleep_still", speed: 1 },
            sleep_back: { frames: [591, 645, 646, 647, 648, 649, 650, 0], next: "idle", speed: 1 },
            look_down_fwd: [218, 222, "look_down_still", 1],
            look_down_still: 222,
            look_down_back: { frames: animationRange(222, 218), next: "idle", speed: 1 },
            lean_left_fwd: [94, 97, "lean_left_still", 1],
            ...
            beat_back: { frames: animationRange(103, 101), next: "idle", speed: 1 },
            cool: {
                frames: [
                    0, 130, 131, 132, 133, 134, 135, 136, 137, 138, 139, 139, 139, 139, 139, 139, 139, 139, 139, 139, 139, 139,
                    135, 136, 137, 138, 139, 139, 139, 139, 139, 139, 139, 139, 139, 139, 139, 139, 139,
                    135, 136, 137, 138, 139, 139, 139, 139, 139, 139, 139, 139, 139, 139, 139, 140,
                    135, 136, 137, 138, 140, 141, 142, 143, 143, 144, 145, 146, 147, 148, 149, 150, 151, 152, 153, 154, 155, 156, 157, 158, 159, 160, 161, 0,
                ],
                next: "idle", speed: 1,
            },
            cool_peedy: {
                frames: [
                    0, 130, 131, 132, 133, 134, 135, 136, 137, 138, 139, 139, 139, 139, 139, 139, 139, 139, 139, 139, 139, 139,
                    135, 136, 137, 138, 139, 139, 139, 139, 139, 139, 139, 139, 139, 139, 139, 139,
                    135, 136, 137, 138, 139, 139, 139, 139, 139, 139, 139, 139, 139, 139, 139, 139, 139, 140,
                    135, 136, 137, 138, 140, 141, 142, 143, 143, 144, 145, 146, 147, 148, 149, 150, 151, 152, 153, 154, 155, 156, 157, 158, 159, 160, 161, 0,
                ],
                next: "idle", speed: 1,
            },
            ...
            cool_left_back: { frames: animationRange(133, 131), next: "cool_still", speed: 1 },
            cool_adjust: { frames: [124, 123, 122, 121, 120, 135, 136, 135, 120, 121, 122, 123, 124], next: "cool_still", speed: 1 },
            present_fwd: [25, 34, "present_still", 1],
            present_still: 34,
            present_back: { frames: animationRange(29, 25), next: "idle", speed: 1 },
            look_left_fwd: [143, 145, "look_left_still", 1],
            look_left_still: 146,
            look_left_back: { frames: animationRange(145, 143), next: "idle", speed: 1 },
            look_left: {
            ...
            lean_right_still: 155,
            lean_right_back: [156, 158, "idle", 1],
            praise_fwd: { frames: [35, 36, 37, 38, 39, 40, 41, 39, 40, 41, 39, 40, 41, 42, 43, 44], next: "praise_still", speed: 1 },
            praise_still: 44,
            praise_back: { frames: animationRange(38, 35), next: "idle", speed: 1 },
            grin_fwd: [743, 753, "grin_still", 1],
            grin_still: 747,
            grin_back: { frames: animationRange(747, 743), next: "idle", speed: 1 },
            taptaptap: { frames: [0], next: "idle", speed: 1 },
...
function characterData(color) {
    ...
    // Any base-bonzi animation key the agent sheet doesn't define gets a no-op
    // stub, so bonzi frame indices never leak onto agent sheets.
    const animations = { ...characterAnimationBase, ...characterStubAnimations, ...profile.animations };
    return { ...window.BonziData, sprite: { ...window.BonziData.sprite, w: profile.sheetWidth, h: profile.sheetHeight, frames: { width: profile.width, height: profile.height }, animations } };
}
